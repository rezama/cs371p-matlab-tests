...
struct TestMatrix : CppUnit::TestFixture {
    ...
    CPPUNIT_TEST(test_lte_2);
    CPPUNIT_TEST(test_lte_3);
    CPPUNIT_TEST(test_gt_2);
    CPPUNIT_TEST(test_gt_3);
    CPPUNIT_TEST(test_gte_2);
    CPPUNIT_TEST(test_gte_3);
